...
function openLinksPergunta() {
    window.open("https://github.com/nicolazs999/Site-perguntas-respostas-basico", "_blank");
    window.open("https://drive.google.com/file/d/1wYBfMZiLcgGvSvEn0ajXl2R4iX4IJRvM/view?usp=sharing", "_blank");
  }
  function openLinksAdopet() {
    window.open("https://github.com/nicolazs999/Adopet", "_blank");
    window.open("https://drive.google.com/file/d/1ZSWWkWaWwGzey8cP-eceAx3UFqeOoZHj/view?usp=sharing", "_blank");
  }
  function openLinksFofo() {
    window.open("https://github.com/nicolazs999/landing-page-barber", "_blank");
    window.open("https://drive.google.com/file/d/15SPGZuS9FTddVb4znz0jHJzXZ_wS740v/view?usp=sharing", "_blank");
  }
